...
* [`ControlWrapper`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/ControlWrapper.html) - create custom widgets which properly encapsulate their base control.
* [`Coat`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/Coat.html) - a functional interface for populating an empty Composite.
* [`SwtExec`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/SwtExec.html) - an `ExecutorService` which executes on the SWT thread.
* [`SwtExec.Guarded`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/SwtExec.Guarded.html) - an `Executor` which is tied to the lifetime of an SWT widget. Say goodbye to `SWTException: Widget is disposed` forever! It can also subscribe to any kind of observable (Guava's ListenableFuture or RxJava's Observable), see [DurianRx](https://github.com/diffplug/durian-rx) for more info. 
```java
...
* [`Layouts`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/Layouts.html) - all the layouts you'll need in SWT
...
* [`Shells`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/Shells.html) - dialogs without boilerplate
...
* [`OnePerWidget`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/OnePerWidget.html) - a cache tied to the lifetime of an SWT Widget.
* [`ColorPool`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/ColorPool.html) - a pool of colors tied to the lifetime of a widget. `ColorPool.forWidget(widget).getColor(rgbValue)`
* [`ImageDescriptors`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/ImageDescriptors.html) - use ImageDescriptors with proper resource sharing. `ImageDescriptors.set(btn, imageDescriptor)`

## Miscellaneous stuff

* [`SwtMisc`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/SwtMisc.html) - useful static methods.
	...
	+ `treeDefControl`, `treeDefComposite` - a [`TreeDef`](http://diffplug.github.io/durian/javadoc/latest/com/diffplug/common/base/TreeDef.html) for traversing UI elements.
	+ `setEnabledDeep` - sets the enabled status of every child, grandchild, etc. of the given composite.

* [`OS`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/os/OS.html), [`Arch`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/os/Arch.html), and [`SwtPlatform`](http://diffplug.github.io/durian-swt/javadoc/latest/com/diffplug/common/swt/os/SwtPlatform.html) - detect things about the running system, and manipulate the SWT jars for build tools.
